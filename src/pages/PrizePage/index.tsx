...
//import video from '../../assets/Video/Konkurs_Premiya.mp4'
              ...
              <section className={styles.menuInfo} >
                  ...
                  activeTab=='mechanika' ? (
                      <>
                       ...
                       <p className={styles.navtabText}>Сбор заявок с предложениями кандидатов конкурса «Премия». Международный мониторинг различных деятелей уличной культуры и спорта. Отбор ТОП-50 Претендентов конкурса «Премия».</p>
                       <h3 className={styles.navtabSubTitle}>18.03.2024–23.03.2024</h3>
                       <p className={styles.navtabText}>Публикация лонг-листов Претендентов конкурса «Премия».</p>
                       <h3 className={styles.navtabSubTitle}>24.03.2024–21.04.2024</h3>
                       <p className={styles.navtabText}>Народное онлайн-голосование. Отбор ТОП-12 Номинантов конкурса «Премия».</p>
                       <h3 className={styles.navtabSubTitle}>22.04.2024–04.05.2024</h3>
                       <p className={styles.navtabText}>Публикация результатов народного онлайн-голосования конкурса «Премия».</p>
                       <h3 className={styles.navtabSubTitle}>05.05.2024–31.05.2024</h3>
                       <p className={styles.navtabText}>Работа независимых Экспертов. Отбор ТОП-3 Лауреатов конкурса «Премия».</p>
                       <h3 className={styles.navtabSubTitle}>01.06.2024–07.06.2024</h3>
                       <p className={styles.navtabText}>Публикация шорт-листов конкурса «Премия».</p>
                       <h3 className={styles.navtabSubTitle}>22.08.2024–25.08.2024</h3>
                       <p className={styles.navtabText}>Гранд-финал, церемония открытия, церемония награждения Победителей конкурса «Премия».</p>
                       <h3 className={styles.navtabSubTitle}>26.08.2024–31.08.2024</h3>
                       <p className={styles.navtabText}>Публикация результатов конкурса «Премия».</p>
                       <h3 className={styles.navtabSubTitle}>01.09.2024–30.09.2024</h3>
                       <p className={styles.navtabText}>Постконкурсное сопровождение Лауреатов и Победителей конкурса «Премия».</p>
                        </>
                  ) : (activeTab == 'requirements' ? (
                     <div> 
                  <h2 className={styles.navtabTitle}>Требования к кандидатам</h2>
                  <ul className={styles.navtabList}>
                      <li>Соответствие конкретному направлению уличной культуры и спорта</li>
                      <li>Популярность внутри направления, аудитория от 500 человек</li>
                  ...
                  <img alt='Требования' className={styles.navtabImg} src={img_requirements}></img>
                  <p className={styles.navtabText}>Эксперты конкурса «Премия» – известные и авторитетные в своём направлении, опытные представители уличной культуры и спорта мира.</p>
                  </div>
                  ) : (
                      <div> 
                  ...
                  <img alt='Критерии' className={styles.navtabImg} src={img_crit}></img>
                  <h3 className={styles.navtabSubTitle}>Критерии равнозначны, диапазон баллов от 1 до 10 по каждому критерию</h3>
                  <p className={styles.navtabText}>Эксперты конкурса «Премия» – известные и авторитетные в своём направлении, опытные представители уличной культуры и спорта мира.</p>
                  </div>
                  ))
                  }
